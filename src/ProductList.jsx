...
function ProductList({ onHomeClick }) {
    ...
    const handleAddToCart = (product) => {
        dispatch(addItem(product)); // Dispatch the action to add the item
        setAddedToCart((prevState) => ({
            ...prevState,
            [product.name]: true, // Track that the product has been added
        }));
    };
                ...
                <div style={styleObjUl}>
                    ...
                    <div>
                        <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
                            ...
                            <span>{totalQuantity}</span> {/* Show the total quantity of items in the cart */}
                        </a>
                    </div>
                </div>
            </div>
